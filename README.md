...
Всего 6 домашних заданий и 10 семинарских заданий.
...
### Семинарские задания:
- Даются на семинаре и сдаются на семинаре
- Те, кто не успел(из-за очереди или по иным причинам) сдать на семинаре имеют возможность отправить ссылку до 23:59 этого же дня(даты семинара) мне(Никите) в лс в ТГ
- Сдавать можно и позже, но применяется аналогичная система, как с дз: каждый день просрочки после дедлайна уменьшает максимально возможную оценку на **1 балл**.
   - Маскимально возможная оценка не может стать **менее 5 баллов**.
